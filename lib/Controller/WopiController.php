...
class WopiController extends Controller {
	...
	public function checkFileInfo($fileId, $access_token) {
		...
		if($user !== null) {
			...
			$response['UserExtraInfo']['avatar'] = $this->urlGenerator->linkToRouteAbsolute('core.GuestAvatar.getAvatar', ['guestName' => $wopi->getGuestDisplayname(), 'size' => self::WOPI_AVATAR_SIZE]);
		}
